  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-bodyBg px-2">
      ...
      <div className="w-full max-w-md bg-cardBg shadow-lg rounded-2xl px-8 py-10 flex flex-col items-center">
        ...
        {/* Google Button */}
        <button
          className="mt-4 w-full text-black flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-medium text-base ring-1 ring-lines bg-white text-text shadow-sm hover:bg-main hover:text-white transition-all duration-150 active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed"
          disabled={!agreed}
          onClick={() => {
            if (!agreed) {
              return;
